        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
               <div class="mt-2">
                ...
                <form action="/user/{{ $blog->user_id }}/blog/{{ $blog->id }}/comment/{{ $comment->id }}/store"
                    method="POST">
                    @csrf
                    ...
                    @enderror
                   <p class="text-right">
                    <button data-modal-hide="reply-comment-popup-modal" type="submit"
